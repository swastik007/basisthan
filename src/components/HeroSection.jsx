...
const HeroSection = () => {
    return(
        <section
        id="home"
        className="bg-gradient-to-b from-blue-900 from-10% via-indigo-900 via-30% to-blue-950 relative overflow-hidden z-10 pt-[120px] pb-[110px] md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 2xl:pb-[200px]"
      >
