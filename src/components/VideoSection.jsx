const VideoSection = () => {
    return(
        <section className="relative h-screen flex flex-col items-center justify-center text-center text-white ">
            ...
            <div
  class="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-20 ">
  <a href=""
  ...
  <p class="font-normal mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
