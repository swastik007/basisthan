const VideoSection = () => {
  ...
  <h1
    ...
    Revolutionize Your Hotel & Restaurant
    <span className="relative whitespace-nowrap text-white-600 "> Operations</span>
    <span className="relative whitespace-nowrap text-[#fc5139] ">
      <svg aria-hidden="true" viewBox="0 0 418 42" className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#ff8676] " preserveAspectRatio="none">
  ...
  <p className="font-normal mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
