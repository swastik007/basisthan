...
const FeatureSection = () => {
    return(
        <section className="bg-gray-100 relative py-24 lg:py-32">
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-start lg:items-center">
            <div className="ml-auto mr-0 lg:w-7/12 lg:pl-16">
              <div className="section-title mb-12">
                <h6 className="text-gray-600 text-sm font-semibold uppercase mb-2">Why Basisthan is best!</h6>
                ...
                <div className="w-full md:w-1/2 px-4 mb-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Basisthan code is easy and requires no/less programming skills to create a website</p>
                      <a className="text-orange-500 hover:text-orange-600 flex items-center mt-4" href="#">
                        Read more <i className="fa fa-angle-right ml-2"></i>
                      </a>
                    </div>
